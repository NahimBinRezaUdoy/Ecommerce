                            ...
                            <form action="{{ route('admin.category.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name"
                                        type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ old('name') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="slug" name="slug"
                                        type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ old('slug') }}">
